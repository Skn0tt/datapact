...
import { AddIcon, Icon, IconProps } from "@chakra-ui/icons"
    ...
    <Container maxW={"5xl"}>
      ...
      >
        ...
        <Text color={"gray.500"} maxW={"3xl"}>
          Datapact Track is an extension to <Code>datapact</Code>. It helps your team to keep track
          of your datasets, monitors data quality + sends you notifications if something breaks.
        </Text>
        <Stack spacing={6} direction={"row"}>
          ...
          <Link href="https://datapact.dev/track.html" isExternal>
        ...
        <Flex w={"full"}>
          <Illustration height={{ sm: "16rem", lg: "20rem" }} mt={{ base: 12, sm: 16 }} />
        </Flex>
      </Stack>
    </Container>
  )
...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <Text>
        Datapact Track is your dataset knowledge tracker. To get started, enter your organisations
        workspace:
      </Text>
